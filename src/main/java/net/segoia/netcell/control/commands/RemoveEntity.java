...
public class RemoveEntity extends BaseCommandExecutor {
	...
	ExecutableEntityDefinition def = (ExecutableEntityDefinition) input.getValue("definition");
	response.put("removed", getNetCellController().removeEntity(def));
	return response;
    }
