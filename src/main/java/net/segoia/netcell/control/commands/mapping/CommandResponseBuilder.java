...
public interface CommandResponseBuilder {
    /**
     * Builds a {@link CommandResponse} from the list of responses of each submitted task for a command
     * @param outputs - the list of responses of each submitted task
     * @return - {@link CommandResponse}
     */
    CommandResponse buildResponse(List<TaskProcessingResponse> outputs);
}
